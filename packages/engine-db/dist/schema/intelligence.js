...
import { mysqlTable, text, timestamp, index, date, varchar, int, decimal, json, } from "drizzle-orm/mysql-core";
 ...
 */
export const dmaicProjects = mysqlTable("dmaic_projects", {
 ...
 */
export const lostOpportunities = mysqlTable("lost_opportunities", {
    id: varchar("id", { length: 36 }).primaryKey().$defaultFn(() => randomUUID()),
    tenantId: varchar("tenant_id", { length: 36 })
        .notNull()
        .references(() => tenants.id, { onDelete: "cascade" }),
 ...
 */
export const seasonalityPatterns = mysqlTable("seasonality_patterns", {
    id: varchar("id", { length: 36 }).primaryKey().$defaultFn(() => randomUUID()),
    tenantId: varchar("tenant_id", { length: 36 })
        .notNull()
        .references(() => tenants.id, { onDelete: "cascade" }),
 ...
 */
export const aeoAudits = mysqlTable("aeo_audits", {
    id: varchar("id", { length: 36 }).primaryKey().$defaultFn(() => randomUUID()),
    tenantId: varchar("tenant_id", { length: 36 })
        .notNull()
        .references(() => tenants.id, { onDelete: "cascade" }),
 ...
 */
export const leadAudits = mysqlTable("lead_audits", {
    id: varchar("id", { length: 36 }).primaryKey().$defaultFn(() => randomUUID()),
    tenantId: varchar("tenant_id", { length: 36 })
        .notNull()
        .references(() => tenants.id, { onDelete: "cascade" }),
 ...
 */
export const processInsights = mysqlTable("process_insights", {
    id: varchar("id", { length: 36 }).primaryKey().$defaultFn(() => randomUUID()),
    tenantId: varchar("tenant_id", { length: 36 })
        .notNull()
        .references(() => tenants.id, { onDelete: "cascade" }),
